...
define('SUPERADMIN_PASSWORD_HASH', password_hash('Super123', PASSWORD_DEFAULT));
...
<head>
    ...
    <style>
        :root {
            ...
            --secondary: #a5b4fc;    /* Light Blue */
            --accent: #f3e8ff;       /* Soft Purple */
            --teal: #6366f1;         /* Indigo/Blue accent */
            --dark: #312e81;         /* Deep Indigo */
            --gold: #FFD700;         /* Gold for superadmin */
            --white: #ffffff;
        ...
        .btn-superadmin {
            ...
            letter-spacing: 0.5px;
            transition: all 0.3s;
            box-shadow: 0 6px 15px rgba(79, 70, 229, 0.10);
            width: 100%;
        }
